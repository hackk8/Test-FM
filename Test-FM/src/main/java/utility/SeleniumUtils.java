...
public class SeleniumUtils {
	...
	public void click(WebDriver driver, String testcaseName, By by, int name, ExtentTest test) {
		WebElement element = driver.findElement(by);
		try {
			element.click();
			test.log(Status.INFO, "Successfully clicked on "+ name +" element.");
	...
	public void waitForLoad(WebDriver driver, String testcaseName, int seconds, ExtentTest test) {
		try {
			try {
				...
				fWait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//img[@id='imgLoader']")));
			} catch (Exception e) {
				WebDriverWait wait = new WebDriverWait(driver, seconds);
				wait.until(ExpectedConditions.invisibilityOfAllElements(driver.findElements(By.xpath("//img[@id='imgLoader']"))));
	...
	public void waitForLoadComment(WebDriver driver, String testcaseName, int seconds, ExtentTest test) {
		try {
			try {
				FluentWait<WebDriver> fWait = new FluentWait<WebDriver>(driver).withTimeout(1, TimeUnit.SECONDS).pollingEvery(100, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class);
				fWait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//img[@id='dvCommentimgLoader']")));
			} catch (Exception e) {
				WebDriverWait wait = new WebDriverWait(driver, seconds);
				wait.until(ExpectedConditions.invisibilityOfAllElements(driver.findElements(By.xpath("//img[@id='dvCommentimgLoader']"))));
				test.log(Status.INFO, "Successfully waited for loader to disappear.");
				Add_Log.info("Successfully waited for loader to disappear.");
				Reporter.log("Successfully waited for loader to disappear.");
			} finally {
	...
	public void waitForLoadReply(WebDriver driver, String testcaseName, int seconds, ExtentTest test) {
		try {
			try {
//				FluentWait<WebDriver> fWait = new FluentWait<WebDriver>(driver).withTimeout(1, TimeUnit.SECONDS).pollingEvery(100, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class);
//				fWait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//span[contains(@class,'cdReplyAttachInProcess')]")));
			} catch (Exception e) {
				WebDriverWait wait = new WebDriverWait(driver, seconds);
				wait.until(ExpectedConditions.invisibilityOfAllElements(driver.findElements(By.xpath("//span[contains(@class,'cdReplyAttachInProcess')]"))));
				test.log(Status.INFO, "Successfully waited for loader to disappear.");
				Add_Log.info("Successfully waited for loader to disappear.");
				Reporter.log("Successfully waited for loader to disappear.");
			} finally {
	...
	public void waitForLoadForm(WebDriver driver, String testcaseName, int seconds, ExtentTest test) {
		try {
			try {
				FluentWait<WebDriver> fWait = new FluentWait<WebDriver>(driver).withTimeout(1, TimeUnit.SECONDS).pollingEvery(100, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class);
				fWait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//img[@alt='loading']")));
			} catch (Exception e) {
				WebDriverWait wait = new WebDriverWait(driver, seconds);
				wait.until(ExpectedConditions.invisibilityOfAllElements(driver.findElements(By.xpath("//img[@alt='loading']"))));
				test.log(Status.INFO, "Successfully waited for loader to disappear.");
				Add_Log.info("Successfully waited for loader to disappear.");
				Reporter.log("Successfully waited for loader to disappear.");
			} finally {
	...
	public void waitForLoader(WebDriver driver, String testcaseName, int seconds, ExtentTest test) {
		try {
			try {
				FluentWait<WebDriver> fWait = new FluentWait<WebDriver>(driver).withTimeout(1, TimeUnit.SECONDS).pollingEvery(100, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class);
				fWait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//img[@alt='loading...']")));
				...
				WebDriverWait wait = new WebDriverWait(driver, seconds);
				wait.until(ExpectedConditions.invisibilityOfAllElements(driver.findElements(By.xpath("//div[text()='Getting your Transaction details...']"))));
				test.log(Status.INFO, "Successfully waited for loader to disappear.");
				Add_Log.info("Successfully waited for loader to disappear.");
				Reporter.log("Successfully waited for loader to disappear.");
			} finally {
	...
	public void waitForLoadSettings(WebDriver driver, String testcaseName, int seconds, ExtentTest test) {
		try {
			try {
				FluentWait<WebDriver> fWait = new FluentWait<WebDriver>(driver).withTimeout(1, TimeUnit.SECONDS).pollingEvery(100, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class);
				fWait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//img[@src='../Lets-Talk/img/loading-gifnew.gif']")));
			} catch (Exception e) {
				WebDriverWait wait = new WebDriverWait(driver, seconds);
				wait.until(ExpectedConditions.invisibilityOfAllElements(driver.findElements(By.xpath("//img[@src='../Lets-Talk/img/loading-gifnew.gif']"))));
				test.log(Status.INFO, "Successfully waited for loader to disappear.");
				Add_Log.info("Successfully waited for loader to disappear.");
				Reporter.log("Successfully waited for loader to disappear.");
			} finally {
	...
	public void waitForLoadDialogue(WebDriver driver, String testcaseName, int seconds, ExtentTest test) {
		try {
			try {
				FluentWait<WebDriver> fWait = new FluentWait<WebDriver>(driver).withTimeout(1, TimeUnit.SECONDS).pollingEvery(100, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class);
				fWait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[@id='dvIndefiniteLoader' and contains(@style,'display: block')]")));
			} catch (Exception e) {
				WebDriverWait wait = new WebDriverWait(driver, seconds);
				wait.until(ExpectedConditions.invisibilityOfAllElements(driver.findElements(By.xpath("//div[@id='dvIndefiniteLoader' and contains(@style,'display: block')]"))));
				test.log(Status.INFO, "Successfully waited for loader to disappear.");
				Add_Log.info("Successfully waited for loader to disappear.");
				Reporter.log("Successfully waited for loader to disappear.");
			} finally {
	...
	public void mouseHoverandClick(WebDriver driver, String testcaseName, WebPageElements ele, ExtentTest test) {
		WebElement element = null;
		Actions action = new Actions(driver);
		try {
			element = getWebElement(driver, testcaseName, ele, test);
			action.moveToElement(element).click(element).build().perform();
			test.log(Status.INFO, "Successfully mouse hovered and clicked on " + ele.getName() + " element.");
			Add_Log.info("Successfully mouse hovered and clicked on " + ele.getName() + " element.");
			Reporter.log("Successfully mouse hovered and clicked on " + ele.getName() + " element.");
		} catch (Exception e) {
			test.log(Status.FAIL, "Not able to click on " + ele.getName() + " element.");
			Add_Log.info("Not able to mouse hover and click on " + ele.getName() + " element.");
			Reporter.log("Not able to mouse hover and click on " + ele.getName() + " element.");
			TestResultStatus.failureReason
					.add(testcaseName + "| Not able to mouse hover and click on  " + ele.getName() + " element.");
			TestResultStatus.TestFail = true;
			Assert.fail();
		}
	}
	
	public void mouseHoverandClick(WebDriver driver, String testcaseName, By by, String name, ExtentTest test) {
		WebElement element = driver.findElement(by);
		Actions action = new Actions(driver);
		try {
			action.moveToElement(element).click(element).build().perform();
			test.log(Status.INFO, "Successfully mouse hovered and clicked on " + name + " element.");
			Add_Log.info("Successfully mouse hovered and clicked on " + name + " element.");
			Reporter.log("Successfully mouse hovered and clicked on " + name + " element.");
		} catch (Exception e) {
			test.log(Status.FAIL, "Not able to mouse hover and click on " + name + " element.");
			Add_Log.info("Not able to mouse hover and click on " + name + " element.");
			Reporter.log("Not able to mouse hover and click on " + name + " element.");
			TestResultStatus.failureReason.add(testcaseName + "| Not able to mouse hover and click on " + name + " element.");
			TestResultStatus.TestFail = true;
			Assert.fail();
		}
	}
	...
	/*
	 * public void hoverAction(WebDriver driver, String testcaseName,
	 * WebPageElements ele, ExtentTest test) {
	 * 
	 * WebElement element = null; try { Actions act = new Actions(driver); element =
	 * getWebElement(driver, testcaseName, ele, test);
	 * act.moveToElement(element).perform(); Add_Log.info("Successfully move on to "
	 * + ele.getName()); test.log(Status.INFO, "Successfully move on to " +
	 * ele.getName()); Reporter.log("Successfully move on to " + ele.getName()); }
	 * catch (Exception e) { test.log(Status.FAIL,
	 * "Not able to mouse hover and click on " + name + " element.");
	 * Add_Log.info("Not able to mouse hover and click on " + name + " element.");
	 * Reporter.log("Not able to mouse hover and click on " + name + " element.");
	 * TestResultStatus.failureReason.add(testcaseName +
	 * "| Not able to mouse hover and click on " + name + " element.");
